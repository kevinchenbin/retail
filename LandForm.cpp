   ...
   //	   constr = constr +dbServer+";Initial Catalog=pddbinfo;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=LEOMA;Use Encryption for Data=False;Tag with column collation when possible=False";
	...
	try
	 ...
	 //	  sblogin->Top = 130;
		 ...
		 LoginConstr = LoginConstr +dbServer+";Initial Catalog=book;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=LEOMA;Use Encryption for Data=False;Tag with column collation when possible=False";
