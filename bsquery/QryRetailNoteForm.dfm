inherited frmQryRetailNote: TfrmQryRetailNote
  Caption = 'POS'#38646#21806#26597#35810
  ExplicitTop = 8
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited grpbx1: TRzGroupBox
    ...
    object dblkpcbbSupplierID: TRzDBLookupComboBox [56]
      Left = 117
      Top = 106
      Width = 235
      Height = 23
    ...
    inherited tbshtByNtHeader: TRzTabSheet
      ...
      inherited dbgrdByNtHeader: TDBGridEh
        ...
        Columns = <
          ...
          item
            EditButtons = <>
            FieldName = 'sijidiscountprice'
            Footer.FieldName = 'sijidiscountprice'
            Footer.ValueType = fvtSum
            Footers = <>
            Title.Alignment = taCenter
            Title.Caption = #23454#38469#25910#27454
            Title.Font.Charset = ANSI_CHARSET
            Title.Font.Color = clNavy
            Title.Font.Height = -12
            Title.Font.Name = #24494#36719#38597#40657
  ...
  inherited dsetByNote: TADODataSet
    Left = 200
    Top = 368
  end
  ...
  inherited dsetByPress: TADODataSet
    Left = 272
    Top = 256
  end
  inherited dsrcByPress: TDataSource
    Left = 352
    Top = 456
  end
  ...
  inherited dsetCustomer: TADODataSet
    CommandText = 'select ID, CardSN from CUST_MemberInfo'
    Left = 40
    Top = 440
  end
  ...
  inherited dsrcPress: TDataSource
    Top = 456
  end
  ...
  inherited dsrcBookType: TDataSource
    Left = 72
    Top = 376
  end
  ...
  inherited ImageList1: TImageList
    ...
    Top = 408
    Bitmap = {
      494C010108000A00F40010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited dsetSupplier: TADODataSet
    CommandText = 
      'select ID, Name from CUST_CustomerInfo where  Type in(1) and cus' +
      'tomerstate=1  order by name'
  end
