...
void TfrmSelectCatalog::QryBkInfo()
{
	...
	case 11://智能入库
		...
		sql = " select BS_BookCatalog.ID,BS_BookCatalog.Author,STK_BookInfo.ID as bkinfoid,STK_BookInfo.SupplierID,BS_BookCatalog.Name,BS_BookCatalog.Barcode,BS_BookCatalog.UserDefCode,BS_BookCatalog.ISBN,CUST_CustomerInfo.Name as SupplierName,STK_BookInfo.Amount,BS_BookCatalog.Price ,BS_PressInfo.fullname,BS_BookCatalog.year,BS_BookCatalog.duokantext,BS_BookCatalog.Presscount "
